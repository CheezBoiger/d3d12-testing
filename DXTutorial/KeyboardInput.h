...
enum KeyCode {
    ...
    KEY_CODE_Y = 0x59,
    KEY_CODE_Z = 0x5A,
    KEY_CODE_LSHIFT = VK_LSHIFT,
    KEY_CODE_RSHIFT = VK_RSHIFT,
    KEY_CODE_LCONTROL = VK_LCONTROL,
    KEY_CODE_RCONTROL = VK_RCONTROL,
    KEY_CODE_COLON = VK_OEM_1,
};


class Keyboard {
public:
    static bool isKeyDown(KeyCode vk);
    static bool isKeyUp(KeyCode vk);
    static bool isKeyStillDown(KeyCode vk);
    static void registerInput(KeyCode vk, InputStatus event);
};
} // jcl